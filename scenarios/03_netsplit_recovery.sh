...
main() {
    ...
    local sub_hosts=""
    local sub_start=$(( total_nodes - (total_nodes - pub_node_count) ))
    ...
    if (( kill_idx_3 >= 0 )); then
        ...
        sleep "$PHASE_SETTLE"
        collect_metrics "p4_partitioned"
